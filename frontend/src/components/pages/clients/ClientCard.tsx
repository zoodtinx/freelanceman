...
const ClientCard = ({ client }: { client: Client }): JSX.Element => {
   ...
   return (
      <div
         className="relative flex flex-col justify-between rounded-[32px] h-[170px] min-w-[150px] p-4 pt-3 leading-tight transition-all text-[#333333] border-2 border-transparent hover:border-primary duration-75 cursor-default"
      ...
      >
         ...
         <div
            className="absolute inset-0 rounded-[30px] transition-opacity bg-slate-100"
