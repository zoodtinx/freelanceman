...
const SalesDocumentBuilderPage = ({
   ...
   const isOnMobile = document.documentElement.clientWidth === 833;

   return (
      <div className="flex flex-col w-full grow bg-foreground rounded-[20px] p-4 pt-3 sm:w-full h-full shrink-0 shadow-md gap-3 overflow-hidden relative">
         {/* Header */}
         ...
         {isOnMobile && (
            <ScrollArea >
               {/* Form */}
               <form
                  className="gap-3 sm:flex-col bg-transparent w-full h-full"
         ...
         {!isOnMobile && (
            <div className="w-full h-full grow ">
               <form
                  className="flex flex-1 grow flex-col h-full gap-3 sm:flex-col"
                  onSubmit={handleSubmit(onSubmit)}
               >
                  <div className="flex grow gap-3 sm:flex-col">
                     <div className="flex flex-col w-1/2 gap-3 sm:flex-col sm:w-full">
