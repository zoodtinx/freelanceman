...
export class ClientContactService {
  ...
  async create(userId: string, dto: CreateClientContactDto) {
    try {
      ...
      throw new InternalServerErrorException('Failed to create client contact');
    }
  }

  async findAll(userId: string, filter: SearchClientContactDto) {
    try {
      ...
      throw new InternalServerErrorException('Failed to search client contacts');
    }
  }
  ...
  async findOne(userId: string, id: string) {
    try {
      ...
      if (!contact) {
        throw new NotFoundException(`Client contact with ID ${id} not found`);
      }
      return contact;
    } catch (error) {
      if (error instanceof NotFoundException) throw error;
      throw new InternalServerErrorException('Failed to find client contact');
    }
  }
  ...
  async update(
    ...
    try {
      ...
      throw new InternalServerErrorException('Failed to update client contact');
    }
  }
  ...
  async remove(userId: string, id: string) {
    try {
      ...
      throw new InternalServerErrorException('Failed to delete client contact');
    }
  }
}
