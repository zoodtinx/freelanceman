...
export const generateNewTropicalBlissBlendPackagingDesignEvents = (
    ids: Ids,
) => {
    return [
        // Finished Events (3)
        {
            ...
            details:
                "Held kick-off meeting to understand packaging goals for 'Tropical Bliss' blend.",
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                'Client approved initial mood board and color palette, setting visual direction.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                'Analyzed competitor packaging to identify trends and differentiation opportunities.',
            isWithTime: false,
            tags: ['research'],
            ...ids,
        },
        // Upcoming Events (7)
        {
            ...
            details:
                'Internal review session for the 3-4 distinct packaging design concepts before client presentation.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                'Present 3-4 distinct packaging design concepts to Aura Tea Co. for feedback.',
        ...
        },
        {
            ...
            details:
                'Prepare a detailed style guide for upcoming product photography, emphasizing freshness and exotic fruits.',
            isWithTime: false,
        ...
        },
        {
            ...
            details:
                'Source and gather quotes for various packaging materials to align with design concepts.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                'Create high-fidelity mockups of the selected packaging design, incorporating client feedback.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                'Meeting with chosen print vendor to discuss specifications and production timelines.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                "Finalize all digital and print assets required for the 'Tropical Bliss' blend launch.",
            isWithTime: false,
            tags: ['launch', 'assets'],
            ...ids,
        },
...
export const generateQ3SocialMediaContentEngagementStrategyEvents = (
    ids: Ids,
) => {
    return [
        // Finished Events (3)
        {
            ...
            details:
                'Gathered objectives and requirements for Q3 social media strategy.',
            isWithTime: true,
            tags: ['brief', 'client'],
            ...ids,
        },
        {
            ...
            details:
                'Submitted comprehensive Q3 social media content and engagement strategy document.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                "Conducted audit of Aura Tea Co.'s current social media platforms and established baseline metrics.",
            isWithTime: false,
        ...
        // Upcoming Events (7)
        {
            ...
            details:
                'Virtual meeting with Ms. Preeya to review Q3 strategy document and discuss user-generated content focus.',
        ...
        },
        {
            ...
            details:
                "Internal brainstorming session to develop creative content ideas and themes for July's calendar.",
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                'Workshop to design engaging graphic assets for Q3 social media posts.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                'Outline specific engagement tactics and community management guidelines for Q3.',
            isWithTime: false,
        ...
        },
        {
            ...
            details:
                'Identify and initiate contact with potential influencers for healthy lifestyle campaigns.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                'Design and set up templates for monthly and quarterly social media performance reports.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                "Configure social listening tools and provide basic training to the client's team.",
            isWithTime: false,
...
export const generateBrandStoryVideoForAboutUsPageEvents = (ids: Ids) => {
    return [
        // Finished Events (3)
        {
            ...
            details:
                'Initial meeting to align on the vision and goals for the Brand Story Video.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                'Sent the first draft of the video script to Mr. Sakda for initial client feedback.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                'Brainstormed and developed initial creative concepts for the brand story video.',
            isWithTime: false,
        ...
        // Upcoming Events (7)
        {
            ...
            dueAt: getRelativeDate(3, true), // June 14
            details:
                'Follow up with Mr. Sakda regarding pending feedback on Script Draft 1.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                'Crucial meeting with Mr. Sakda to confirm the budget, especially for travel, to restart the project.',
            isWithTime: true,
        ...
        },
        {
            ...
            dueAt: getRelativeDate(10, true), // June 21
            details:
                'Travel to Chiang Rai to scout and finalize suitable filming locations for the video.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                'Book necessary crew members and secure all required filming equipment for the shoot.',
            isWithTime: false,
        ...
        },
        {
            ...
            dueAt: getRelativeDate(20, true), // July 1
            details:
                'Collaborative session to finalize the visual storyboard for the brand story video.',
            isWithTime: true,
        ...
        },
        {
            ...
            dueAt: getRelativeDate(25, true), // July 6
            details:
                'Comprehensive meeting with all involved teams (creative, production, client) to review final plan.',
            isWithTime: true,
        ...
        },
        {
            ...
            details:
                'Conduct auditions to select the voice-over artist for the Brand Story Video.',
            isWithTime: false,
            tags: ['voice', 'casting'],
            ...ids,
        },
...
export const getAuraTeaCoEvents = (ids: Ids) => {
    const auraTeaCoEventGenerators: [string, any][] = [
        [
            'New Tropical Bliss Blend Packaging Design',
            generateNewTropicalBlissBlendPackagingDesignEvents,
        ],
        [
            'Q3 Social Media Content & Engagement Strategy',
            generateQ3SocialMediaContentEngagementStrategyEvents,
        ],
        [
            "Brand Story Video for 'About Us' Page",
            generateBrandStoryVideoForAboutUsPageEvents,
        ],
    ];

    return auraTeaCoEventGenerators.flatMap(([projectTitle, generateFn]) => {
        const projectIds = ids[projectTitle];

        if (!projectIds) {
            console.warn(
                `Warning: IDs not found for project: "${projectTitle}" for Aura Tea Co. No events generated.`,
            );
            return [];
        }
